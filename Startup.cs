...
namespace TMS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<dbToolsManagementContext>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IServiceProvider services)
        {
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.MapRoute(
                      name: "tsa",
                      template: "TSA",
                      defaults: new { controller = "TSA", action = "Index" });
                routes.MapRoute(
                     name: "toolassign",
                     template: "ToolAssign",
                     defaults: new { controller = "ToolAssign", action = "Index" }); 
                routes.MapRoute(
                     name: "toolsetup",
                     template: "ToolSetup",
                     defaults: new { controller = "ToolSetup", action = "Index" });
                routes.MapRoute(
                     name: "ReceiveAttachement",
                     template: "ReceiveAttachement",
                     defaults: new { controller = "ReceiveAttachement", action = "Index" });
